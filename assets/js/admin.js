jQuery(document).ready(function ($) {
	...
	window.fetchAirtableTables = function(appId){
	...
	$('#wpc-wpcf7-airtable-app-id-selected').each(function () {
		fetchAirtableTables($(this).val());
	});


    function checkAndToggleErrorMessage() {
        if ($('#wpc-wpcf7-airtable-app-id-selected, #wpc-wpcf7-airtable-table-id-selected').length) {
