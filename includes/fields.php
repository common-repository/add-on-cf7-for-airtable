...
/**
 * Map WPCF7 hidden field.
 *
 * @param array $fields The supported WPCF7/Airtable fields.
 * @return array
 */
function map_wpcf7_hidden( $fields ) {
	$fields['hidden'] = array(
		'singleLineText'  => array(
			__NAMESPACE__ . '\flatten_values',
			__NAMESPACE__ . '\airtable_single_line_text_format',
...
/**
 * Map WPCF7 custom field.
 *
 * @param array $fields The supported WPCF7/Airtable fields.
 * @return array
 */
function map_wpcf7_custom($fields) {
	global $wpconnect_wpcf7_airtable_custom_cf7_tags;

	foreach ($wpconnect_wpcf7_airtable_custom_cf7_tags as $tag_name) {
 ...
 * @return bool
 */
function airtable_return_true( $field_value ) { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.Found
	return true;
}
