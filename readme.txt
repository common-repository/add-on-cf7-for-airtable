...
* Fix: Fixed issues with field formatting.
* Feature : Added the ability to define hidden fields and custom form tags for Airtable

= 2.2.0 =
* WordPress 6.5.0 compatibility
* Fix: JavaScript code that is executed on all pages
* Feature: Checks for CF7 form file field mapping and enhance server environment validation

= 2.1.0 =
* WordPress 6.4.0 compatibility
* Feature: Sending an email to the administrator upon an API error

= 2.0.0 =
* WordPress 6.3.1 compatibility
* Improvement: Use Airtable access tokens instead of API key
* Fix: Error when using the checkbox field type
...
= 1.0.1 =
* Feature: compatibility with new v5.6 of Contact Form 7
* Improvement: Airtable integration help link
